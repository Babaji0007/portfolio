		...
		>
			<div className={styles.container}>
				...
				>
					...
					<a
						href='mailto: rahul.hooda1995@gmail.com'
						aria-label='email'
						target='_blank'
						rel='noreferrer'
					>
					...
					<a
						href='https://github.com/Babaji0007'
						aria-label='GitHub'
						rel='noreferrer'
						target='_blank'
					>
					...
					<a
						href='https://www.linkedin.com/in/rahul-hooda-b79399230/'
						aria-label='Linkedin'
						target='_blank'
						rel='noreferrer'
					>
			...
			>
				Designed and build by Rahul Hooda, 2022 All rights
				reserved.
			</div>
		</footer>
	);
